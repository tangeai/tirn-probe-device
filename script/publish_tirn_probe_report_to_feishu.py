#!/usr/bin/env python3
"""Convert an tirn-probe report directory into a child Feishu Wiki document.
...
REPORT_GENERATOR = SCRIPT_DIR / "generate_tirn_probe_netem_report.py"
...
def main():
    parser = argparse.ArgumentParser(
        description=f"发布 tirn-probe 测试报告到固定父节点 {PARENT_WIKI_URL}"
    )
